                         ...
                         <form method="POST">
                              ...
                              $id = $_GET['id'];
                                   if(isset($_POST['submit'])){
                                        ...
                                        $ulasan = $_POST['ulasan'];
                                        $rating = $_POST['rating'];
                                        $query=mysqli_query($koneksi, "UPDATE tb_ulasan SET id_buku='$id_buku', ulasan='$ulasan', rating='$rating' WHERE id_ulasan=$id");
                                        if($query){
                                             echo '<script> alert ("Ubah ulasan berhasil")
                                             document.location.href="ulasan.php"</script>
                                             </script>';
                                   ...
                                   $query=mysqli_query($koneksi, "SELECT * FROM tb_ulasan WHERE id_ulasan=$id");
