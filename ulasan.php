...
<body>
	...
	<div class="wrapper">
	   ...
	   <!-- Ini bagian atas pojok kanan (navbar profil user) -->
		 ...
		 <a href="ulasan_tambah.php" class="btn btn-primary" >+ Tambah ulasan</a>
        </div>
	<?php
		   $i = 1;
		   $query = mysqli_query($koneksi, "SELECT * FROM tb_ulasan LEFT JOIN tb_user ON tb_user.id_user = tb_ulasan.id_user LEFT JOIN tb_buku ON tb_buku.id_buku = tb_ulasan.id_buku");
		  ...
		  <p><?php echo $data['ulasan']; ?></p>
            ...
            <div class="d-flex justify-content-between">
              <div class="d-flex flex-row align-items-center">
                <img src="img/avatars/profil.jpg" alt="avatar" width="25"
                  height="25" />
                <p class="medium mb-0 ms-2"><?php echo $data['nama'] . " >> "; echo $data['judul'];?> </p>
              </div>
            </div>
          <!-- </div> -->
        </div>
