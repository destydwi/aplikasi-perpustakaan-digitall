                         ...
                         <form method="post">
                              ...
                              $id = $_GET['id']; 
                                   if(isset($_POST['submit'])){
                                        ...
                                        $query=mysqli_query($koneksi, "UPDATE tb_buku SET id_kategori='$id_kategori', judul='$judul', foto='$foto', stok = '$stok', penulis='$penulis', penerbit='$penerbit', tahun_terbit='$tahun_terbit', deskripsi='$deskripsi' WHERE id_buku=$id");
                              ...
                              <div class="row mb-4">
                                   ...
                                   <div class="col-md-8"><input type="file" value="<?php echo $data['foto'];?>" class="form-control" name="foto" required></div>
                              </div>
                              <div class="row mb-4">
                                   <div class="col-md-3">Stok</div>
                                   <div class="col-md-8"><input type="number" value="<?php echo $data['stok'];?>" class="form-control" name="stok" required></div>
                              </div>
                              <div class="row mb-4">
                              ...
                              <div class="row mb-4">
                                   ...
                                   <div class="col-md-8"><textarea name="deskripsi" rows="5" class="form-control" required > <?php echo $data['deskripsi']; ?> </textarea>
                              </div>
                              </div>
                                   <div class="col-md-8">
