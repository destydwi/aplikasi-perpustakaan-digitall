                         ...
                         <form method="post">
                              ...
                              $id=$_GET['id'];
                                   if(isset($_POST['submit'])){
                                        ...
                                        $status = $_POST['status'];
                                        $query=mysqli_query($koneksi, "UPDATE tb_peminjaman SET id_buku='$id_buku', tanggal_peminjaman='$tanggal_peminjaman',tanggal_pengembalian='$tanggal_pengembalian', status='$status' WHERE id_peminjaman=$id");

                                        if($query){
                                             echo '<script> alert ("Ubah data laporan peminjaman berhasil")
                                             location.href="laporan.php"
                                             </script>';
                                        }else{
                                             echo '<script> alert ("Ubah data laporan peminjaman gagal")</script>';
                                        }
                                   }
                                   $query = mysqli_query($koneksi, "SELECT * FROM tb_peminjaman WHERE id_peminjaman=$id");
