        ...
        <div class="navbar-collapse collapse">
            ...
            <main class="content">
              ...
              <div class="row mb-3">
                ...
                <?php
                        $i = 1;
                        $query = mysqli_query($koneksi, "SELECT * FROM tb_buku LEFT JOIN tb_kategori ON tb_buku.id_kategori = tb_kategori.id_kategori");
                        while ($data = mysqli_fetch_array($query)) {
                        ?>
                    
                <div class="col-md-3">
                <form action="aksi_keranjang.php?id_buku=<?=$data['id_buku']?>" method="post">  
                    <div class="card" >
                    ...
                    if($_SESSION['tb_user']['level'] !='peminjam'){
                        ?>
                    <a href="buku_edit.php?id=<?= $data['id_buku'] ?>" class="btn btn-primary">Edit</a>
                    <a onclick="return confirm('Apakah anda yakin menghapus buku ini?');" href="buku_hapus.php?id=<?php echo $data['id_buku']; ?>" class="btn btn-danger">Hapus</a>
                    
                    <?php
                    }else{
                        ?>
                    <a class="main-content-link" href="aksi_favorit.php?id_buku=<?=$data['id_buku']?>">
              <i class="align-middle" data-feather="bookmark"></i> <span class="align-middle">Koleksi</span>
                    </a><br><br>
