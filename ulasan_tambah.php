                         ...
                         <form method="post">
                              <?php 
                                   if(isset($_POST['submit'])){
                                        ...
                                        $ulasan = $_POST['ulasan'];
                                        $rating = $_POST['rating'];
                                        $query=mysqli_query($koneksi, "INSERT INTO tb_ulasan (id_buku, id_user, ulasan, rating) VALUES ('$id_buku', '$id_user', '$ulasan', '$rating')");

                                        if($query){
                                             echo '<script> alert ("Tambah ulasan berhasil")
                              ...
                              <div class="row mb-4">
                                   ...
                                   <div class="col-md-8">
                                   <div class="col-md-8"><input type="number" class="form-control" name="rating" min="1" max="5"></div>
                                   </div>
                              </div>
                                   <div class="col-md-8">
